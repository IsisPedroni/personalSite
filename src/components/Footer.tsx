      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div className="text-center mb-16" {...motionProps()}>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto mb-8">
            <motion.div
              className="bg-gray-900 p-6 rounded-lg text-left w-full"
              {...motionProps(0.2)}
            >
              <Phone className="text-white mx-auto mb-3" size={28} aria-hidden="true" />
              <div className="text-white mb-2">Phone</div>
              <a
                href={`tel:${PHONE_TEL}`}
                className="text-a11y-muted hover:text-white transition-colors block mb-3"
              >
                {PHONE_DISPLAY}
              </a>
              <button
            ...
            <motion.div className="bg-gray-900 p-6 rounded-lg" {...motionProps(0.3)}>
              <Mail className="text-white mx-auto mb-2" size={24} aria-hidden="true" />
            ...
            <motion.div className="bg-gray-900 p-6 rounded-lg" {...motionProps(0.1)}>
              <MapPin className="text-white mx-auto mb-3" size={28} aria-hidden="true" />
